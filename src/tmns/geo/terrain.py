...
# Project Libraries
from tmns.geo.coord import Transformer, Geographic, Coordinate, Coordinate_Type, UTM, UPS, Web_Mercator, ECEF
...
class Manager:
    ...
    def __init__(
        ...
        self.cache_file = Path(tempfile.gettempdir()) / "terminus_core_python" / "elevation_cache.pkl"
